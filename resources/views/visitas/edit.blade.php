 ...
 .selected {
    ...
    <div class="page-heading card" style="box-shadow: none !important">
        ...
        <section class="section pt-4">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('visitas.update', $visita) }}" method="POST" style="" onsubmit="return saveCanvasToInput()">
                        @csrf
                        @method('PUT')
                        <input type="hidden" id="foto_danos" name="foto_daños" value="{{ $visita->foto_daños }}">
                        ...
                        <div class="row">
                                    ...
                                    <div>
                                        <select class="form-control select2" id="coche_id" name="coche_id" required>
                                            ...
                                            @foreach($coches as $coche)
                                                <option value="{{ $coche->id }}" {{ $visita->coche_id == $coche->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" id="color" name="color" value="{{ $visita->color }}">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                                    <label for="kilometraje">Kilometraje</label>
                                    <input type="number" name="kilometraje" class="form-control" value="{{ $visita->kilometraje }}">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                                    ...
                                    <div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="ingreso_grua" id="ingreso_grua_no" value="0" {{ $visita->ingreso_grua == 0 ? 'checked' : '' }}>
                                            <label class="form-check-label" for="ingreso_grua_no">
                                                No
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="ingreso_grua" id="ingreso_grua_si" value="1" {{ $visita->ingreso_grua == 1 ? 'checked' : '' }}>
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="date" name="fecha_ingreso" class="form-control" id="fecha_ingreso" value="{{ $visita->fecha_ingreso }}">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                                    <label for="fecha_salida">Fecha Salida</label>
                                    <input type="date" name="fecha_salida" class="form-control" value="{{ $visita->fecha_salida }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="trabajo_a_realizar" class="form-control">{{ $visita->trabajo_a_realizar }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="observaciones" class="form-control">{{ $visita->observaciones }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-1">
                                <div class="form-group mb-3">
                                    <svg fill="#000000" height="50px" width="50px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
                                        ...
                                        <input type="hidden" name="airbag" value="{{ $visita->airbag }}">
                            ...
                            <div class="col-md-1">
                                ...
                                <svg id="svg1" fill="#000000" width="50px" height="50px" viewBox="0 -14.14 122.88 122.88" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"  style="enable-background:new 0 0 122.88 94.59" xml:space="preserve">
                                    ...
                                    <input type="hidden" name="motor" value="{{ $visita->motor }}">
                            ...
                            <div class="col-md-1">
                                ...
                                <input type="hidden" name="abs" value="{{ $visita->abs }}">
                            ...
                            <div class="col-md-1">
                                ...
                                <input type="hidden" name="aceite" value="{{$visita->aceite}}">
                            ...
                            <div class="col-md-1">
                                    <svg version="1.1"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
                                        ...
                                        <input type="hidden" name="bateria" value="{{ $visita->bateria }}">
                            ...
                            <div class="col-md-1">
                                ...
                                <svg fill="#000000" height="50px" width="50px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
	                                viewBox="0 0 512 512" xml:space="preserve">
                                        ...
                                        <input type="hidden" name="cinturon" value="{{ $visita->cinturon }}">
                            ...
                            <div class="col-md-1">
                                ...
                                <input type="hidden" name="parking" value="{{ $visita->parking }}">
                            ...
                            <div class="col-md-1">
                                <svg fill="#000000" height="50px" width="50px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
                                    ...
                                    <input type="hidden" name="luces" value="{{ $visita->luces }}">
                            ...
                            <div class="col-md-1">
                                <svg fill="#000000" height="50px" width="50px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
                                    ...
                                    <input type="hidden" name="neumaticos" value="{{ $visita->neumaticos }}">
                            ...
                            <!-- Repeat for other SVG icons and hidden inputs -->
                        ...
                        <button type="submit" class="btn btn-primary mt-3" style="margin-top: 300px !important;">Actualizar</button>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Cargar la imagen del canvas desde el campo foto_danos
        const fotoDanos = document.getElementById('foto_danos').value;
        if (fotoDanos) {
            const img = new Image();
            img.onload = function() {
                ctx.drawImage(img, 0, 0, canvas.width, canvas.height);
            };
            img.src = fotoDanos; // Asegúrate de que este valor sea una URL válida o un base64 correcto
        }
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        svgs.forEach(svg => {
            ...
            // Aplica la clase 'selected' si el valor del input es '1'
            if (input.value === '1') {
