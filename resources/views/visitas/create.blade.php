                    ...
                    <form action="{{ route('visitas.store') }}" method="POST" style="">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-1">
                                ...
                                <svg fill="#000000" width="50px" height="50px" viewBox="0 -14.14 122.88 122.88" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"  style="enable-background:new 0 0 122.88 94.59" xml:space="preserve">
